...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0">{{ __('Customer Ledger') }}</h5>
    </div>
@endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Customer Ledger') }}</li>
@endsection
    ...
    @can('Manage Customer')
        ...
        <div class="row mt-3">
            <div class="col-xl-12">
                <div class="card p-3">
                    <h3>Add Ledger</h3>
                    <h4 class="mt-4">Customer: {{ $customer->name }}</h4>
                    <form method="post">
                        @csrf
                        <div class="row">
                            <div class="col-4">
